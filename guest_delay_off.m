function [delay,interval_1] = guest_delay_off(guest,guest_information,moment)
early = 1.5
late = 2
    for i = 1 : size(guest,2)
        interval_1 = guest_information(guest(1,i),9)
        interval_2 = guest_information(guest(1,i),10)
